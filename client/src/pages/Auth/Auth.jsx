    ...
    <div className='Auth'>
        ...
        <div className="a-right">
            <form className="infoForm authForm" onSubmit={handleSubmit}>
                ...
                <div>
                    <input type="text" placeholder='User Name' className="infoInput" name='username' onChange={handleChange}
                    value={data.username}/>
                </div>
                ...
                <span style={{display: confirmPass? "none" : "block", color:"red", fontSize:"12px", alignSelf:"flex-end", marginTop: "5px"}}> * Confirm Password is not same</span>
